...
add_action('init', function () {
	// Shortcode: [articles_category_panels categories="slug-de-categorie1, slug-de-categorie2,..." posts="2" exclude="slug-a,slug-b"]
	add_shortcode('articles_category_panels', function ($atts) {
		$a = shortcode_atts([
			'categories' => '',
			'posts'      => 6,
			'exclude' 	 => ''
